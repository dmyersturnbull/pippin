...
/**
  ...
  */
class RestrictedDuplicateMessageFilter(@BeanProperty var packagesAlwaysAllowed: String, @BeanProperty var nRepetitionsAllowed: Int = 50, @BeanProperty var cacheSize: Int = 200, @BeanProperty var fixedLogLevel: Int = -1) extends TurboFilter {
